        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Table Diskon</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a class="btn btn-primary" href="{{ route('diskon.create') }}">Tambah
                            Diskon +</a>
                        <!-- Input Search -->
                        <div class="input-group w-25 mt-2">
                            <span class="input-group-text" id="basic-addon1">Search</span>
                            <input type="text" id="search-input" class="form-control" placeholder="Cari diskon..."
                            ...
                            <tbody>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item"
                                                        href="{{ route('diskon.edit', $data->id) }}">
                               ...
                               document.getElementById('delete-form-{{ $data->id }}').submit();">
                                                    ...
                                                    <form id="delete-form-{{ $data->id }}" method="POST"
                                                        action="{{ route('diskon.destroy', $data->id) }}"
                                                        style="display: none;">
                                                        @csrf
                                                        @method('delete')
                                                    </form>
